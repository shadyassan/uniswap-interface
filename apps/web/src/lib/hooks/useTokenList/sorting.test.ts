...
describe('tokenQuerySortComparator', () => {
  ...
  it('should return tokens that start with "us" first', () => {
    const result = [DAI, USDC_MAINNET, USDT].sort(
      tokenQuerySortComparator('us')
    );
