      ...
      <Container>
        ...
        <OutageTextContainer>
          <ThemedText.BodySmall lineHeight="20px">
            <Trans>
              {version ? version.toString().toLowerCase() + ' data' : 'Data'}{' '}
              will be back soon
            </Trans>
          ...
          <ThemedText.LabelMicro>
            <Trans>
              ...
              {version ? ' ' + version.toString().toLowerCase() : ''} data is
              unavailable right now, but we expect the issue to be resolved
              shortly.
            </Trans>
          </ThemedText.LabelMicro>
          <ThemedText.LabelMicro>
